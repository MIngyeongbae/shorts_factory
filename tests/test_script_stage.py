...
def test_timestamps_are_derived_from_char_count():
    """산술은 세션이 아니라 코드가 한다."""
    raw = [
        {"beat": "hook_fact", "text": "열두 글자짜리 문장.", "visual_goal": "그림이 지는 설명", "subject": "피사체",
         "subject_scale": "wide"},
        {"beat": "ending_echo", "text": "또 다른 문장입니다.", "visual_goal": "그림이 지는 설명", "subject": "피사체",
         "subject_scale": "wide"},
    ]
...
def test_session_supplied_timestamps_are_ignored():
    ...
    raw = [{"beat": "hook_fact", "text": "문장.", "visual_goal": "그림이 지는 설명", "subject": "피사체",
...
def test_unknown_subject_scale_is_rejected(scale):
    ...
    scene = {"beat": "hook_fact", "text": "문장.", "visual_goal": "그림이 지는 설명", "subject": "피사체"}
...
def test_subject_scale_reaches_the_scene_contract():
    raw = [{"beat": "hook_fact", "text": "문장.", "visual_goal": "그림이 지는 설명", "subject": "댐 단면 일러스트",
...
def test_unknown_beat_is_rejected():
    raw = [{"beat": "hook", "text": "문장.", "visual_goal": "그림이 지는 설명", "subject": "피사체",
            "subject_scale": "wide"}]
...
def test_number_beat_without_number_is_rejected():
    raw = [{"beat": "solution_number", "text": "숫자가 없는 문장.", "visual_goal": "그림이 지는 설명", "subject": "피사체",
            "subject_scale": "wide"}]
