...
- **[3. tts+sync]**: 대본 전체 단일 호출 + with-timestamps. 문자 정렬에서 문장 경계 start/end 추출해 scenes.json 갱신. 실측-추정 오차 씬당 ±1.5초 초과 시 경고, 총 길이 100초 초과 시 대본 축약 재생성 트리거. atempo 1.1 적용 후 타임스탬프도 1/1.1 스케일 보정.
